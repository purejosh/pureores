...
public class LonsdaleiteMeteoriteOnStructureInstanceGeneratedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		for (int index0 = 0; index0 < 40; index0++) {
			sequence_y = 7;
			random_x = Mth.nextInt(RandomSource.create(), 2, 16);
			random_z = Mth.nextInt(RandomSource.create(), 2, 16);
			trying_y = true;
			while (trying_y == true) {
