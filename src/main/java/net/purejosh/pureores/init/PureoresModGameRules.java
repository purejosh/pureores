...
public class PureoresModGameRules {
	...
	public static void load() {
		PURE_ORES_LONSDALEITE_GENERATION_CHANCE = GameRuleRegistry.register("pure_ores_lonsdaleite_generation_chance", GameRules.Category.MISC, GameRuleFactory.createIntRule(100));
