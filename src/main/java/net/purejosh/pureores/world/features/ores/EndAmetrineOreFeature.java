...
public class EndAmetrineOreFeature extends OreFeature {
	...
	public boolean place(FeaturePlaceContext<OreConfiguration> context) {
		...
		if (!EndAmetrineOreAdditionalGenerationConditionProcedure.execute(world))
			return false;
