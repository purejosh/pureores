...
public abstract class JadeiteArmorItem extends ArmorItem {
	public JadeiteArmorItem(Type type, Item.Properties properties) {
	...
	public static class Helmet extends JadeiteArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends JadeiteArmorItem {
	...
	public static class Leggings extends JadeiteArmorItem {
	...
	public static class Boots extends JadeiteArmorItem {
